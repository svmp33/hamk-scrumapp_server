...
// Average Temperature
    public String getTempAvg(String s, String e, String r) {
        ...
        try {
            ...
            rs.next();
            // while (rs.next()) {
          /*  System.out.print("The average temperature between " + start + " and " + end + " was ");
...
// Maximum Temperature
    public String getTempMax(String s, String e, String r) {
        ...
        try {
            ...
            rs.next();
          /*  System.out.print("The maximum temperature between " + start + " and " + end + " was ");
            System.out.print(rs.getString(1));
            System.out.println("°C"); */
...
// Minimum Temperature
    public String getTempMin(String s, String e, String r) {
        ...
        try {
            ...
            rs.next();
      /*      System.out.print("The minimum temperature between " + start + " and " + end + " was ");
            System.out.print(rs.getString(1));
            System.out.println("°C"); */
